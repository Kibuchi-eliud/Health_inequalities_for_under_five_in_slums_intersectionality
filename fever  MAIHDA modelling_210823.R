...
#Import data
ncss12_full <- read.csv("NCSSS2012_children fever_210823.csv")
names(ncss12_full)
#====================================================================================================================
...
#hh_religiongrp,hh_insurance_grouped,hhCHE40,hhfood_availability,Income_genActivitygrp,hh_staygrp2
ncss12_full$hhd_wealthquintile <- as.factor(ncss12_full$hhd_wealthquintile)
ncss12_full$hhd_wealthquintile <- relevel(ncss12_full$hhd_wealthquintile, ref = "rich")
...
#disability
ncss12_full$hh_disability <- as.factor(ncss12_full$hh_disability); summary(ncss12_full$hh_disability)
ncss12_full$hh_disability <- relevel(ncss12_full$hh_disability, ref = "no")



#===================================================
#Distribution of sociodeterminants factors 
CrossTable(ncss12_full$child_agegrp, ncss12_full$child_fever)
CrossTable(ncss12_full$child_gender, ncss12_full$child_fever)
CrossTable(ncss12_full$woman_agegrp, ncss12_full$child_fever)
CrossTable(ncss12_full$hoh_sex, ncss12_full$child_fever)
CrossTable(ncss12_full$hoh_ethnicgrp, ncss12_full$child_fever)
CrossTable(ncss12_full$hoh_agegrp, ncss12_full$child_fever)
CrossTable(ncss12_full$hh_educgrp, ncss12_full$child_fever)
CrossTable(ncss12_full$hhd_wealthquintile, ncss12_full$child_fever)
CrossTable(ncss12_full$hh_staygrp2, ncss12_full$child_fever)
CrossTable(ncss12_full$hh_religiongrp, ncss12_full$child_fever)
CrossTable(ncss12_full$hh_disability, ncss12_full$child_fever)
CrossTable(ncss12_full$hhtenure, ncss12_full$child_fever)
CrossTable(ncss12_full$hhfood_availability, ncss12_full$child_fever)
CrossTable(ncss12_full$Income_genActivitygrp, ncss12_full$child_fever)
CrossTable(ncss12_full$hh_insurance_grouped, ncss12_full$child_fever)
CrossTable(ncss12_full$hhCHE40, ncss12_full$child_fever)

#-======================================================================
ncss12_full$child_fever<-as.factor(ncss12_full$child_fever)
ncss12_full$fever <- ncss12_full$child_fever
summary(ncss12_full$fever)
#========================================================================
#child_agegrp

ncss12_full$child_agegrp<-as.factor(ncss12_full$child_agegrp)
child_agegrp_model1<- glm(fever ~ 1 + child_agegrp, family=binomial(link='logit'), data = ncss12_full) 
print(summary(child_agegrp_model1), digits = 2)

#child_gender
child_gender_model1<- glm(fever ~ 1 + child_gender, family=binomial(link='logit'), data = ncss12_full) 
print(summary(child_gender_model1), digits = 3)

# hhhead_sex
ncss12_full$hoh_sex <- as.factor(ncss12_full$hoh_sex )
hhhead_sex_model1<- glm(fever ~ 1 + hoh_sex, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hhhead_sex_model1), digits = 3)

#hhhead_agegrp
ncss12_full$hoh_agegrp <- as.factor(ncss12_full$hoh_agegrp)
hhhead_agegrp_model1<- glm(fever ~ 1 + hoh_agegrp, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hhhead_agegrp_model1), digits = 3)

#hhead_ethnicgrp
ncss12_full$hoh_ethnicgrp <- as.factor(ncss12_full$hoh_ethnicgrp)
hhead_ethnicgrp_model1<- glm(fever ~ 1 + hoh_ethnicgrp, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hhead_ethnicgrp_model1), digits = 3)

#hhd_wealthquintile
ncss12_full$hhd_wealthquintile <- as.factor(ncss12_full$hhd_wealthquintile)
hhd_wealthquintile_model1<- glm(fever ~ 1 + hhd_wealthquintile, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hhd_wealthquintile_model1), digits = 3)

#hh_staygrp2
hh_staygrp2_model1<- glm(fever ~ 1 + hh_staygrp2, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hh_staygrp2_model1), digits = 3)

#hh_insurance_grouped
hh_insurance_grouped_model1<- glm(fever ~ 1 + hh_insurance_grouped, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hh_insurance_grouped_model1), digits = 3)

#hhCHE40
hhCHE40_model1<- glm(fever ~ 1 + hhCHE40, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hhCHE40_model1), digits = 3)

#hhfood_availability
hhfood_availability_model1<- glm(fever ~ 1 + hhfood_availability, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hhfood_availability_model1), digits = 3)

#Income_genActivitygrp
Income_genActivitygrp_model1<- glm(fever ~ 1 + Income_genActivitygrp, family=binomial(link='logit'), data = ncss12_full) 
print(summary(Income_genActivitygrp_model1), digits = 3)

#Highest household education 
hh_highestEdu_model1<- glm(fever ~ 1 + hh_educgrp, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hh_highestEdu_model1), digits = 3)

#"hh_religiongrp" 
hh_religiongrp_model1<- glm(fever ~ 1 + hh_religiongrp, family=binomial(link='logit'), data = ncss12_full) 
...
hh_disability_model1<- glm(fever ~ 1 + hh_disability, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hh_disability_model1), digits = 3)

#Women age 
women_agegrp_model1<- glm(fever ~ 1 + woman_agegrp, family=binomial(link='logit'), data = ncss12_full) 
print(summary(women_agegrp_model1), digits = 3)

#Tenure  
summary(ncss12_full$hhtenure)
hhtenure_model1<- glm(fever ~ 1 + hhtenure, family=binomial(link='logit'), data = ncss12_full) 
print(summary(hhtenure_model1), digits = 3)

#============================================================================================================================
#============================================================================================================================
#Create intersection strata for all significant univariate variables 
#child_gender,hoh_ethnicgrp,hhd_wealthquintile,hh_staygrp2,hhCHE40,hhfood_availability,woman_agegrp

ncss12_full$sig_pid <- ncss12_full%>% group_indices(child_gender,hoh_ethnicgrp,hhd_wealthquintile,hh_staygrp2,hhCHE40,hhfood_availability,woman_agegrp) 
...
#Intercept model
#============================================================================================================================
sig_model1 <- brm(fever ~ 1 + (1|sig_pid), data = ncss12_full,family = bernoulli,warmup = 2000, iter = 20000, control = list(adapt_delta = 0.90),
                  cores = 2, chains = 2, 
                  seed = 123)
summary(sig_model1)
...
#In the current data, the target response is having a fever. 
...
Prob <- Prob[,1]
Pred <- prediction(Prob, as.vector(pull(ncss12_full, fever)))
...
#=====================================================================================================
#VPC Indicates the share of the total individual varinace  in the propensity for having fever that is accounted for at the intersectional strata level.
variance_group <- 0.48^2; variance_group 
VPC_model1 <- 0.48^2 / (0.48^2 +3.29)*100; VPC_model1
...
fever_group1_model1 <- merge(ncss12_full, r_Intercept2, by = "sig_pid") 

#Export data
write.csv(fever_group1_model1, file = "fever_sig_model1.csv")
...
sig_model2 <- brm(fever ~ 1 + child_gender + hoh_ethnicgrp + hhd_wealthquintile + hh_staygrp2 + hhCHE40 + hhfood_availability + woman_agegrp + (1|sig_pid),
...
modell2_Pred <- prediction(model2_Prob, as.vector(pull(ncss12_full, fever)))
...
#VPC
model2_variance <-    0.25^2; model2_variance 
model2_vpc <-   0.25^2 / ( 0.25^2 +3.29)*100; model2_vpc
#modell2_vpc =1.86% 

#PCV
model1_variance <-  0.48^2
model2_variance <-  0.25^2
model2_PCV <- ( 0.48^2 -  0.25^2)/ 0.48^2 ; model2_PCV
model2_PCV <- model2_PCV*100; model2_PCV
#PCV=72.53%
#This indicates 27.47% of variance was not explained by adding fixed effects 
#=================================================================================================
#Plot
...
fever_group1_model2 <- merge(ncss12_full, r2_Intercept2, by = "sig_pid") 


#Export data
write.csv(fever_group1_model2, file = "fever_sig_model2.csv")
#=================================================================================
...
#====================================================================================
names(ncss12_full)
sig_model3 <- brm(fever ~ 1 + child_agegrp + child_gender + woman_agegrp + woman_educgrp + hoh_sex + hoh_agegrp + hoh_ethnicgrp +
...
model3_Pred <- prediction(model3_Prob, as.vector(pull(ncss12_full, fever)))
...
model3_variance <-    0.30^2; model3_variance 
model3_vpc <-   0.30^2 / ( 0.30^2 +3.29)*100; model3_vpc
#modell2_vpc =9.86% 

#PCV
model1_variance <- 0.48^2
model3_PCV <- (0.48^2 -  0.30^2)/0.48^2 ; model3_PCV
...
fever_group1_model3 <- merge(ncss12_full, r3_Intercept3, by = "sig_pid") 


#Export data
write.csv(fever_group1_model3, file = "fever_sig_model3.csv")
#================
#Plots 
grid.arrange(plot1, plot2,plot3, nrow=3, ncol=1)

fever_plot <- ggpubr::ggarrange(plot1, plot2,plot3, ncol = 1, nrow = 3)

ggsave('fever.pdf',fever_plot, width =18,height=15,dpi=1200)
